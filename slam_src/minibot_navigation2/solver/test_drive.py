...
class GoalSubscriber:
    ...
    def subscribe(self):
        #rclpy.init()
        node = rclpy.create_node('goal_subscriber')
        self.subscriber = node.create_subscription(Int32, 'aruco_id', self.callback, 10)
...
def main():
    ...
    goal_pose.header.frame_id = 'map'
    goal_pose.header.stamp = navigator.get_clock().now().to_msg()
    goal_pose.pose.position.x = -0.3033531904220581
    goal_pose.pose.position.y = -0.4876289367675781
    goal_pose.pose.orientation.z = 0.450693383506524
    goal_pose.pose.orientation.w = 0.892678819096455
    
    goal_pose = PoseStamped()
    goal_pose.header.frame_id = 'map'
    goal_pose.header.stamp = navigator.get_clock().now().to_msg()
    goal_pose.pose.position.x = 0.017118453979492188
    goal_pose.pose.position.y = 0.015325784683227539
    goal_pose.pose.orientation.z = -0.26655083137572366
    goal_pose.pose.orientation.w = 0.9638208621382454
    
    goal_pose = PoseStamped()
    goal_pose.header.frame_id = 'map'
    goal_pose.header.stamp = navigator.get_clock().now().to_msg()
    goal_pose.pose.position.x = 0.5769392577441993
    goal_pose.pose.position.y = -0.43399156158840846
    goal_pose.pose.orientation.z = -0.8272857052020762
    goal_pose.pose.orientation.w = 0.5617814183188186
...
# 
    ...
    # goal_pose_1.pose.position.x = 0.0771390453055478
    # goal_pose_1.pose.position.y = -0.03556606702952142
    # goal_pose_1.pose.orientation.z = -0.6845749077980176
    # goal_pose_1.pose.orientation.w = 0.7289425187306169
#    
    # goal_pose_1 = PoseStamped()
    # goal_pose_1.header.frame_id = 'map'
    # goal_pose_1.header.stamp = navigator.get_clock().now().to_msg()
    # goal_pose_1.pose.position.x = 0.0531927779739269
    # goal_pose_1.pose.position.y = 0.49975126994125885
    # goal_pose_1.pose.orientation.z = -0.729984417648241
    # goal_pose_1.pose.orientation.w = 0.683463788353676
# 
    # goal_pose_1 = PoseStamped()
    # goal_pose_1.header.frame_id = 'map'
    # goal_pose_1.header.stamp = navigator.get_clock().now().to_msg()
    # goal_pose_1.pose.position.x = 0.45526618913384936
    # goal_pose_1.pose.position.y = -2.1973543766605528
    # goal_pose_1.pose.orientation.z = 0.777120276737929
    # goal_pose_1.pose.orientation.w = 0.6293521077129755
...
# 
    ...
    # goal_pose_2.pose.position.x = 0.0771390453055478
    # goal_pose_2.pose.position.y = -0.03556606702952142
    # goal_pose_2.pose.orientation.z = -0.6845749077980176
    # goal_pose_2.pose.orientation.w = 0.7289425187306169
#    
    # goal_pose_2 = PoseStamped()
    # goal_pose_2.header.frame_id = 'map'
    # goal_pose_2.header.stamp = navigator.get_clock().now().to_msg()
    # goal_pose_2.pose.position.x = 0.0531927779739269
    # goal_pose_2.pose.position.y = 0.49975126994125885
    # goal_pose_2.pose.orientation.z = -0.729984417648241
    # goal_pose_2.pose.orientation.w = 0.683463788353676
# 
    # goal_pose_2 = PoseStamped()
    # goal_pose_2.header.frame_id = 'map'
    # goal_pose_2.header.stamp = navigator.get_clock().now().to_msg()
    # goal_pose_2.pose.position.x = 0.45526618913384936
    # goal_pose_2.pose.position.y = -2.1973543766605528
    # goal_pose_2.pose.orientation.z = 0.777120276737929
    # goal_pose_2.pose.orientation.w = 0.6293521077129755
...
# 
    ...
    # goal_pose_3.pose.position.x = 0.0771390453055478
    # goal_pose_3.pose.position.y = -0.03556606702952142
    # goal_pose_3.pose.orientation.z = -0.6845749077980176
    # goal_pose_3.pose.orientation.w = 0.7289425187306169
#    
    # goal_pose_3 = PoseStamped()
    # goal_pose_3.header.frame_id = 'map'
    # goal_pose_3.header.stamp = navigator.get_clock().now().to_msg()
    # goal_pose_3.pose.position.x = 0.0531927779739269
    # goal_pose_3.pose.position.y = 0.49975126994125885
    # goal_pose_3.pose.orientation.z = -0.729984417648241
    # goal_pose_3.pose.orientation.w = 0.683463788353676
# 
    # goal_pose_3 = PoseStamped()
    # goal_pose_3.header.frame_id = 'map'
    # goal_pose_3.header.stamp = navigator.get_clock().now().to_msg()
    # goal_pose_3.pose.position.x = 0.45526618913384936
    # goal_pose_3.pose.position.y = -2.1973543766605528
    # goal_pose_3.pose.orientation.z = 0.777120276737929
    # goal_pose_3.pose.orientation.w = 0.6293521077129755
