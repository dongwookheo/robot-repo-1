...
int main(void)
{
  ...
  HAL_TIM_PWM_Start(&htim8, TIM_CHANNEL_2);  // start the pwm2
  HAL_TIM_PWM_Start(&htim8, TIM_CHANNEL_3);  // start the pwm3
  HAL_TIM_PWM_Start(&htim8, TIM_CHANNEL_4);  // start the pwm4
  /* USER CODE END 2 */
